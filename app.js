...
const pokemonDivInnerHTML = `
 <div class="image-container">
        ...
        <div class="poke-info">
            ...
            <div class="small">
                <small class="poke-exp"><i class="fa solid fa-flash"></i>${pokemon.base_experience}</small>
                <small class="poke-weight"><i class="fa solid fa-flash"></i>${pokemon.weight}</small>
            </div>
            <div class="poke-type">
